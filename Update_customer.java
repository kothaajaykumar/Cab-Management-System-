...
public class Update_customer extends JFrame implements ActionListener {
    ...
    Update_customer() {
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("cab_booking/images/1.jpg"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b1) {
            ...
            try{
                connectionclass obj=new connectionclass();
                String q="update customer set name='" + name + "',age='" + age + "',dob='" + dob
                        + "',address='" + address + "',phone='" + phone + "',email='" + email + "',country='" + country + "',gender='" + gender + "',aadhar='"
                        + aadhar + "' where username='"+username+"'";
