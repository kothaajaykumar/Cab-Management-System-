...
public class Book_package extends JFrame implements ActionListener {
    ...
    Book_package() {
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("cab_booking/images/truck.jpeg"));
        ...
        ch2.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent arg1) {
                ...
                try{
                    ...
                    String q = "select * from transport_driver where source='" + source + "' and destination='"+dest+"'";
                    ResultSet rs = obj.stm.executeQuery(q);
                    while (rs.next()) {
                        t4.setText(rs.getString("driver"));
                        t5.setText(rs.getString("truck"));
                        t6.setText(rs.getString("source"));
                        t7.setText(rs.getString("destination"));
                        t8.setText(rs.getString("price"));
                        t9.setText(rs.getString("distance"));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == b1) {
            ...
            String truck = t5.getText();
            String price = t8.getText();
            String weight = ch4.getSelectedItem();
            String dist = t9.getText();
            String name = t2.getText();

            try{
                connectionclass obj = new connectionclass();
                String q= "insert into transport_package(bid,username,dname,truck,source,destination,price,distance,name,weight) values('" + bid + "','"
                        + user + "','" + dname + "','" + truck + "','" + source + "','" + dest + "','" + price + "','"+dist+"','"+name+"','"+weight+"')";
