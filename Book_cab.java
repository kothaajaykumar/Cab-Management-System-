...
public class Book_cab extends JFrame implements ActionListener {
    ...
    Book_cab() {
        ...
        try{
            ...
            String q = "select DISTINCT source from intracity_driver";
        ...
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("cab_booking/images/bmw.jpg"));
        ...
        ch2.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent arg1) {
                ...
                try{
                    ...
                    String q = "select * from intracity_driver where source='" + source + "' and destination='"+dest+"'";
                    ResultSet rs = obj.stm.executeQuery(q);
                    while (rs.next()) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == b1) {
            ...
            try{
                connectionclass obj = new connectionclass();
                String q= "insert into intracity_cab(bid,username,dname,car,source,destination,price) values('" + bid + "','"
                        + user + "','" + dname + "','" + car + "','" + source + "','" + dest + "','" + price + "')";
